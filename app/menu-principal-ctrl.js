...
// comprobar si esta abierta
       ...
       if (existe==1) return;
        ...
        $(ventanaID).append('<script src="/menu/app/modulo/'+href+'-ctrl.js"></script>');
        $(ventanaID).append('<link rel="stylesheet" type="text/css" href="/menu/app/modulo/'+href+'.css">');
